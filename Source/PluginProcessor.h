...
public:
	...
	void delayTime(const int doublerBufferLength, AudioBuffer<float>& buffer, const int bufferLength, const float* doublerBufferData, const float* doublerBufferData2);
